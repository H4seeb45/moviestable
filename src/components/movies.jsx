...
class Movies extends Component {
  ...
  render() {
    ...
    return (
     <div className="p-4 m-4 rounded  container  mx-auto ">
       {<Search  item={"Products"}/>}
        <div className="mx-auto">
        <div className="mb-4 rounded bg-gray-200 p-2 w-20">
          <h3 className=" text-2xl text-blue-400 text-bold">Products</h3>
        </div>
        <div className="row">
          <div className="col-2">
            {" "}
